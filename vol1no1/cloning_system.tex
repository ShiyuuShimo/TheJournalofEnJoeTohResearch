...
\begin{document}
	...
	\begin{thebibliography}{99}
		...
		\bibitem{nlab} cardinal number, \textit{nLab}, 2023, \url{https://ncatlab.org/nlab/show/cardinal+number}

		\bibitem{geb} ダグラス・R・ホフスタッター, 『ゲーデル，エッシャー，バッハ : あるいは不思議の扉』, 白揚社, 1985

		\bibitem{shr} さはら, Life Universe, \textit{oimo.io}, 2022, \url{https://oimo.io/works/life/}
